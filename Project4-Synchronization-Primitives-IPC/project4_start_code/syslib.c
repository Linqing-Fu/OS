...
int mylock_init(){
  return invoke_syscall(SYSCALL_LOCK_INIT, IGNORE, IGNORE, IGNORE);
}

int mylock_acq(int i){
  return invoke_syscall(SYSCALL_LOCK_ACQUIRE, i, IGNORE, IGNORE);
}

int mylock_real(int i){
  return invoke_syscall(SYSCALL_LOCK_RELEASE, i, IGNORE, IGNORE);
}
